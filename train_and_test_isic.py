...
from Models.EENet_ddw import Frame_1, Frame_2, Frame_3, Frame_4
...
def main(args, val_acc_log, test_acc_log):
    ...
    model = Test_Model[args.id](image_size=args.out_size, classes=args.num_classes, channels=args.num_input) 
    model = model.cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--id', default="Frame_4",
                        help='Frame_4')                                                   # Select a loaded model name

    # Path related arguments
    parser.add_argument('--root_path', default='/data/project_ddw/LightWeight_Unet/skin_lesion_segmentation/Datasets/ISIC_2018/ISIC2018_npy_all_224_224',
                        help='root directory of training data')                                      # storage path of ISIC2018 dataset 
    parser.add_argument('--ckpt', default='./saved_models_0721/',
    ...
    parser.add_argument('--root_ph2', default='/data/project_ddw/LightWeight_Unet/skin_lesion_segmentation/Datasets/PH2_npy_224_320',
                        help='root directory of external validation')                                      # storage path of ph2 data
    parser.add_argument('--root_ph2_list', default='/data/project_ddw/LightWeight_Unet/skin_lesion_segmentation/Datasets/PH2_npy_224_320/ph2_list.txt',
